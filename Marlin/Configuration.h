...
#define STRING_VERSION_CONFIG_H "2012-09-10" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "SR" //Who made the changes.
...
// RSEchoRap Motherboard use 12 for Gen7 1.3.1, use 9 for Printrboard
#ifndef MOTHERBOARD
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {44.4444,44.4444,2267.717,400}  // RS EchoRap
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 45}    // (mm/sec)   // RS EchoRap reduction de Z 5 a 2  
