NOTE:
-----
The firmware has been tested on a EchoRap with a 3mm filament on a JHead 0.35mm. 
To install on a RSEchoRap with RepRap Gen7 Electronics v1.3.1  Rev, use the Arduino IDE. 
